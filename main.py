...
while True:
    ...
    # Step 10:Check if contact with wall and display "You Lose"
    ...
    # Clear the segments
        segments.clear()
        head.write("You Lose", align="center", font=("Arial", 24, "normal"))
